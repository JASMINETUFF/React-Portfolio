                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src='./assets/Images/dayPlanner.png'/>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="Images/goodReadMe.png"/>
                                        <div class="card-body text-center">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="Images/passwordGen.png"/>
                                        <div class="card-body text-center">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="Images/codeQuiz.png"/>
                                        <div class="card-body text-center">
                        ...
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div class="card">
                                        <img class="img-fluid" alt="100%x280" src="Images/weatherDash.png"/>
                                        <div class="card-body text-center">
